...
<html>
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      /*
      (async ()=> {
        var res = await fetch("https://i.imgur.com/qRRfxeo.jpeg")
        console.log(res);
        res.blob().then((res) => {
          console.log(res);
          console.log(URL.createObjectURL(res));
          document.getElementById("myimage").src = URL.createObjectURL(res)
        })
      })()
      */
    </script>
